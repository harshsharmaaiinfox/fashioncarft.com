...
if ( ! function_exists( 'dunker_core_add_back_to_top_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function dunker_core_add_back_to_top_options( $page ) {
		...
		if ( $page ) {
			...
			$page->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Back to Top Icon SVG Path', 'dunker-core' ),
					'description' => esc_html__( 'Enter your back to top icon SVG path here. Please remove version and id attributes from your SVG path because of HTML validation', 'dunker-core' ),
					'dependency'  => array(
						'show' => array(
			...
			$back_to_top_section = $page->add_section_element(
				array(
					...
					'title'      => esc_html__( 'Back to Top Styles', 'dunker-core' ),
					'dependency' => array(
						'show' => array(
							'qodef_back_to_top' => array(
								'values'        => 'yes',
	...
	add_action( 'dunker_core_action_after_general_options_map', 'dunker_core_add_back_to_top_options', 15 );
}
