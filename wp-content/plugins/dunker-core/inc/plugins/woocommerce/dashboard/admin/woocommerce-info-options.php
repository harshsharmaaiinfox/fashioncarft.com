...
if ( ! function_exists( 'dunker_core_add_product_info_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function dunker_core_add_product_info_typography_options( $page ) {
		...
		if ( $page ) {
			$product_info_tab = $page->add_tab_element(
				array(
					...
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'Product Info', 'dunker-core' ),
					'description' => esc_html__( 'Set typography values for product info elements', 'dunker-core' ),
				)
			);
			...
			$price_typography_section = $product_info_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Price Typography', 'dunker-core' ),
				)
			);
			...
			$product_price_typography_row = $price_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Product Price Styles', 'dunker-core' ),
				)
			);
			...
			$product_price_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Discount Color', 'dunker-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$product_single_price_typography_row = $price_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Product Single Price Styles', 'dunker-core' ),
				)
			);
			...
			$product_info_typography_section = $product_info_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Product Info Typography', 'dunker-core' ),
				)
			);
			...
			$product_label_typography_row = $product_info_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Product Info Label Styles', 'dunker-core' ),
				)
			);
			...
			$product_info_typography_row = $product_info_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Product Info Styles', 'dunker-core' ),
				)
			);
			...
			$product_info_link_typography_row = $product_info_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Product Info Link Styles', 'dunker-core' ),
				)
			);
	...
	add_action( 'dunker_core_action_after_woo_options_map', 'dunker_core_add_product_info_typography_options' );
}
