<?php
$product_list_image = $product_list_image ?? get_post_meta( get_the_ID(), 'qodef_product_list_image', true );
...
if ( $has_image ) {
	...
	<div class="qodef-e-media-image">
		...
		?>
			<?php echo dunker_core_get_list_shortcode_item_image( $image_dimension, $product_list_image, $custom_image_width, $custom_image_height ); ?>
		<?php
