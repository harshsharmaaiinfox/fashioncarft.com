...
if ( ! class_exists( 'DunkerCore_Checkout_Integration' ) ) {
	class DunkerCore_Checkout_Integration {
		...
		/**
		 * @return DunkerCore_Checkout_Integration
		 */
		...
		function include_files() {
			include_once DUNKER_CORE_PLUGINS_PATH . '/checkout/payment/class-wc-product-qodef.php';
			include_once DUNKER_CORE_PLUGINS_PATH . '/checkout/payment/class-wc-qodef-data-store-cpt.php';
			include_once DUNKER_CORE_PLUGINS_PATH . '/checkout/payment/class-wc-order-item-qodef.php';
			include_once DUNKER_CORE_PLUGINS_PATH . '/checkout/payment/class-wc-order-item-qodef-data-store.php';
		}
		...
		public function supported_post_types() {
			return apply_filters( 'dunker_core_filter_checkout_integration_post_types', array() );
		}
	...
	DunkerCore_Checkout_Integration::get_instance();
}
