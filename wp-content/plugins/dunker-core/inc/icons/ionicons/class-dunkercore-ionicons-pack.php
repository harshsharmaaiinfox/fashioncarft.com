...
if ( ! function_exists( 'dunker_core_add_ionicons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function dunker_core_add_ionicons_to_collection( $icons ) {
		$icons[] = 'DunkerCore_IonIcons_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'dunker_core_add_ionicons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class DunkerCore_IonIcons_Pack extends QodeFrameworkIconPack {
		...
		function specific_icons() {
			return apply_filters(
				'dunker_core_filter_ion_specific_icons',
				array(
