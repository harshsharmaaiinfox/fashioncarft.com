...
if ( ! function_exists( 'dunker_core_add_elegant_icons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function dunker_core_add_elegant_icons_to_collection( $icons ) {
		$icons[] = 'DunkerCore_Elegant_Icons_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'dunker_core_add_elegant_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class DunkerCore_Elegant_Icons_Pack extends QodeFrameworkIconPack {
		...
		public function get_style_url() {
			return DUNKER_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/assets/css/' . $this->get_base() . '.min.css';
		}
		...
		function specific_icons() {
			return apply_filters(
				'dunker_core_filter_elegant_specific_icons',
				array(
					'search'        => 'icon_search',
