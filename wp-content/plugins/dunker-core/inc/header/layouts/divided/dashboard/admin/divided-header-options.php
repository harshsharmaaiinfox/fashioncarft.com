...
if ( ! function_exists( 'dunker_core_add_divided_header_options' ) ) {
	/**
	 ...
	 */
	function dunker_core_add_divided_header_options( $page, $general_header_tab ) {
	...
	add_action( 'dunker_core_action_after_header_options_map', 'dunker_core_add_divided_header_options', 10, 2 );
}
