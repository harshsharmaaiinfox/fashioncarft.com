...
class DunkerCore_Vertical_Sliding_Header extends DunkerCore_Header {
	...
	public function __construct() {
		...
		add_filter( 'dunker_core_filter_available_header_logo_images', array( $this, 'set_logo_image' ) );

		parent::__construct();
	}

	/**
	 * @return DunkerCore_Vertical_Sliding_Header
	 */
