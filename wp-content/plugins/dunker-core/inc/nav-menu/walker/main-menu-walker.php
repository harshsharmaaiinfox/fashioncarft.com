...
if ( ! class_exists( 'DunkerCoreRootMainMenuWalker' ) ) {
	class DunkerCoreRootMainMenuWalker extends Walker_Nav_Menu {
		...
		public function start_lvl( &$output, $depth = 0, $args = null ) {
			...
			if ( 0 === $depth ) {
				...
				$inner_classes = apply_filters( 'dunker_core_filter_drop_down_second_inner_classes', array( 'qodef-drop-down-second-inner' ) );
		...
		public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
			...
			$anchor_link      = dunker_core_get_option_value( 'nav-menu', 'qodef-enable-anchor-link', '', $item->ID );
			$menu_appearance  = dunker_core_get_option_value( 'nav-menu', 'qodef-menu-item-appearance', '', $item->ID );
			$mega_menu_widget = dunker_core_get_option_value( 'nav-menu', 'qodef-enable-mega-menu-widget', '', $item->ID );
			$menu_icon_pack   = dunker_core_get_option_value( 'nav-menu', 'qodef-menu-item-icon-pack', '', $item->ID );
			$menu_icon        = dunker_core_get_option_value( 'nav-menu', 'qodef-menu-item-icon-pack-icon', '', $item->ID );
