...
if ( ! class_exists( 'DunkerCore_Shortcodes' ) ) {
	class DunkerCore_Shortcodes {
		...
		function init() {
			...
			include_once DUNKER_CORE_SHORTCODES_PATH . '/dashboard/customizer/shortcodes-customizer-options.php';
		}
		...
		function include_shortcode_classes() {
			include_once DUNKER_CORE_SHORTCODES_PATH . '/class-dunkercore-shortcode.php';
			include_once DUNKER_CORE_SHORTCODES_PATH . '/class-dunkercore-list-shortcode.php';
		}
		...
		function register_shortcodes() {
			...
			$shortcodes     = apply_filters( 'dunker_core_filter_register_shortcodes', $shortcodes = array() );
	...
	DunkerCore_Shortcodes::get_instance();
}
