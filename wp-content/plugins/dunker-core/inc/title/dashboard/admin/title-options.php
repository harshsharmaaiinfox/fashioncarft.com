...
if ( ! function_exists( 'dunker_core_add_page_title_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function dunker_core_add_page_title_options() {
		...
		$page = $qode_framework->add_options_page(
			array(
				...
				'description' => esc_html__( 'Global Title Options', 'dunker-core' ),
			)
		);
		...
		if ( $page ) {
			...
			$page_title_section->add_field_element(
				array(
					...
					'options'       => apply_filters( 'dunker_core_filter_title_layout_options', array() ),
			...
			do_action( 'dunker_core_action_after_page_title_options_map', $page_title_section );
		}
	}

	add_action( 'dunker_core_action_default_options_init', 'dunker_core_add_page_title_options', dunker_core_get_admin_options_map_position( 'title' ) );
}
