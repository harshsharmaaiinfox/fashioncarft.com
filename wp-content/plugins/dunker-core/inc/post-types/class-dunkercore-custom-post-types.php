...
if ( ! class_exists( 'DunkerCore_Custom_Post_Types' ) ) {
	class DunkerCore_Custom_Post_Types {
		...
		/**
		 * @return DunkerCore_Custom_Post_Types
		 */
		...
		function init() {
			...
			include_once DUNKER_CORE_CPT_PATH . '/dashboard/customizer/post-types-customizer-options.php';
		}
		...
		function set_enabled_post_types() {
			...
			do_action( 'dunker_core_action_add_custom_post_type', $this );
		}
		...
		function register_post_types() {
			...
			$cpts           = apply_filters( 'dunker_core_filter_register_custom_post_types', $cpts = array() );
		...
		function include_taxonomies() {
			...
			do_action( 'dunker_core_action_include_cpt_tax_fields' );
		}

		function register_taxonomies() {
			// Hook to includes custom post types taxonomy fields
			do_action( 'dunker_core_action_register_cpt_tax_fields' );
		}
	...
	DunkerCore_Custom_Post_Types::get_instance();
}
