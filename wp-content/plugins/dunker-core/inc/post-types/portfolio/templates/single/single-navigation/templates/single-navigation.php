<?php
$is_enabled = dunker_core_get_post_value_through_levels( 'qodef_portfolio_enable_navigation' );

if ( 'yes' === $is_enabled ) {
	$through_same_category = 'yes' === dunker_core_get_post_value_through_levels( 'qodef_portfolio_navigation_through_same_category' );
	?>
	<div id="qodef-single-portfolio-navigation" class="qodef-m">
		<div class="qodef-m-inner">
			...
			$post_navigation        = array(
				'prev'      => array(
					'icon' => dunker_core_get_svg_icon( 'pagination-arrow-left', 'qodef-m-nav-left' ),
				),
				'back-link' => array(),
				'next'      => array(
					'icon' => dunker_core_get_svg_icon( 'pagination-arrow-right', 'qodef-m-nav-right' ),
				),
			);
			...
			if ( '' !== $back_to_link ) {
				$post_navigation['back-link'] = array(
					...
					'icon'    => dunker_core_get_svg_icon( 'back-link' ),
				);
			}
