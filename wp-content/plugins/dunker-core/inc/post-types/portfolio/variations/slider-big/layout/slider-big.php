		...
		<div class="qodef-e-inner">
			<div class="qodef-media qodef-swiper-container qodef--slider">
				<div class="swiper-wrapper">
					<?php dunker_core_template_part( 'post-types/portfolio', 'templates/parts/post-info/media', 'slider' ); ?>
				</div>
				<?php dunker_core_template_part( 'content', 'templates/swiper-nav', '', array( 'slider_navigation' => 'yes' ) ); ?>
			</div>
			<div class="qodef-e-content qodef-grid qodef-layout--template <?php echo dunker_core_get_grid_gutter_classes(); ?>" <?php echo dunker_core_get_grid_gutter_styles(); ?>>
				<div class="qodef-grid-inner">
					<div class="qodef-grid-item qodef-col--9 qodef-col--content">
						<?php dunker_core_template_part( 'post-types/portfolio', 'templates/parts/post-info/title' ); ?>
