...
do_action( 'dunker_core_action_before_team_content_holder' );
?>
	<main id="qodef-page-content" class="qodef-grid qodef-layout--template <?php echo esc_attr( dunker_core_get_grid_gutter_classes() ); ?>" <?php echo dunker_core_get_grid_gutter_styles(); ?> role="main">
		<div class="qodef-grid-inner">
			...
			dunker_core_template_part( 'post-types/team', 'templates/team', $template_slug );
...
do_action( 'dunker_core_action_after_team_content_holder' );
?>
