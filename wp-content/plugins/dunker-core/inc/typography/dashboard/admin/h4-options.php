...
if ( ! function_exists( 'dunker_core_add_h4_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function dunker_core_add_h4_typography_options( $page ) {
		...
		if ( $page ) {
			$h4_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h4',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H4 Typography', 'dunker-core' ),
					'description' => esc_html__( 'Set values for Heading 4 HTML element', 'dunker-core' ),
				)
			);
	...
	add_action( 'dunker_core_action_after_typography_options_map', 'dunker_core_add_h4_typography_options' );
}
