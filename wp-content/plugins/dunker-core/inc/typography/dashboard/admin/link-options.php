...
if ( ! function_exists( 'dunker_core_add_link_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function dunker_core_add_link_typography_options( $page ) {
		...
		if ( $page ) {
			$link_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-link',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'Link Typography', 'dunker-core' ),
					'description' => esc_html__( 'Set values for link', 'dunker-core' ),
				)
			);
	...
	add_action( 'dunker_core_action_after_typography_options_map', 'dunker_core_add_link_typography_options' );
}
