...
class DunkerCore_Covers_Header_Search extends DunkerCore_Search {
	...
	/**
	 * @return DunkerCore_Covers_Header_Search
	 */
	...
	public function load_template() {
		if ( is_active_widget( false, false, 'dunker_core_search_opener' ) ) {
			...
			$actions         = array();
			$sidebars        = qode_framework_get_widget_sidebars( 'dunker_core_search_opener' );
			...
			foreach ( $sidebars as $sidebar ) {
				if ( 'qodef-header-widget-area-one' === $sidebar || 'qodef-header-widget-area-two' === $sidebar ) {
					$actions[] = 'dunker_action_after_page_header_inner';
					$actions[] = 'dunker_core_action_after_sticky_header';
				} elseif ( 'qodef-mobile-header-widget-area' === $sidebar ) {
					$actions[] = 'dunker_action_after_page_mobile_header_inner';
					$actions[] = 'dunker_core_action_after_page_mobile_header_inner';
				} elseif ( 'qodef-top-area-left' === $sidebar || 'qodef-top-area-right' === $sidebar ) {
					$actions[] = 'dunker_core_action_after_top_area';
