<?php if ( has_nav_menu( 'mobile-navigation' ) || has_nav_menu( 'main-navigation' ) ) { ?>
	<nav class="qodef-mobile-header-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Mobile Menu', 'dunker-core' ); ?>">
		<?php
		...
		wp_nav_menu(
			array(
				...
				'container'      => '',
				'menu_class'     => 'yes' === dunker_core_get_post_value_through_levels( 'qodef_mobile_header_in_grid' ) ? 'qodef-content-grid' : '',
