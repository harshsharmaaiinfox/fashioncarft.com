...
if ( ! function_exists( 'dunker_core_add_page_mobile_logo_meta_box' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function dunker_core_add_page_mobile_logo_meta_box( $logo_tab ) {
		...
		if ( $logo_tab ) {
			...
			$mobile_header_logo_section = $logo_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Mobile Header Logo Options', 'dunker-core' ),
				)
			);
			...
			$mobile_header_logo_section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Mobile Logo Height', 'dunker-core' ),
					'description' => esc_html__( 'Enter mobile logo height', 'dunker-core' ),
					'args'        => array(
			...
			$mobile_header_logo_section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Mobile Logo Padding', 'dunker-core' ),
					'description' => esc_html__( 'Enter mobile logo padding value (top right bottom left)', 'dunker-core' ),
				)
			);
			...
			$mobile_header_logo_section->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Mobile Logo Source', 'dunker-core' ),
					'options'       => array(
			...
			$logo_image_section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Mobile Logo - Main', 'dunker-core' ),
					'description' => esc_html__( 'Choose main mobile logo image', 'dunker-core' ),
					'multiple'    => 'no',
				)
			);

			// Hook to include additional options after section part
			do_action( 'dunker_core_action_after_mobile_logo_image_section_meta_map', $logo_tab, $mobile_header_logo_section, $logo_image_section );
			...
			// Hook to include additional options after section part
			do_action( 'dunker_core_action_after_mobile_logo_svg_path_section_meta_map', $logo_tab, $mobile_header_logo_section, $logo_svg_path_section );
			...
			// Hook to include additional options after section part
			do_action( 'dunker_core_action_after_mobile_logo_textual_section_meta_map', $logo_tab, $mobile_header_logo_section, $logo_textual_section );

			// Hook to include additional options after module options
			do_action( 'dunker_core_action_after_page_mobile_logo_meta_map', $mobile_header_logo_section );
		}
	}

	add_action( 'dunker_core_action_after_page_mobile_header_meta_map', 'dunker_core_add_page_mobile_logo_meta_box' );
}
