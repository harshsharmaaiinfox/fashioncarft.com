...
if ( ! function_exists( 'dunker_core_dependency_for_mobile_menu_typography_options' ) ) {
	/**
	 * Function that set dependency values for module global options
	 *
	 * @return array
	 */
	function dunker_core_dependency_for_mobile_menu_typography_options() {
		return apply_filters( 'dunker_core_filter_mobile_menu_typography_hide_option', array() );
	}
}

if ( ! function_exists( 'dunker_core_set_mobile_header_styles' ) ) {
	/**
	 ...
	 * @return string
	 */
	function dunker_core_set_mobile_header_styles( $style ) {
		$opener_styles    = array();
		$opener_color     = dunker_core_get_post_value_through_levels( 'qodef_mobile_header_opener_color' );
		$opener_icon_size = dunker_core_get_post_value_through_levels( 'qodef_mobile_header_opener_size' );
		...
		$opener_hover_color  = dunker_core_get_post_value_through_levels( 'qodef_mobile_header_opener_hover_color' );
	...
	add_filter( 'dunker_filter_add_inline_style', 'dunker_core_set_mobile_header_styles' );
}
