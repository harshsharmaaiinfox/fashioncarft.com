...
if ( ! function_exists( 'dunker_core_add_standard_mobile_header_options' ) ) {
	/**
	 ...
	 */
	function dunker_core_add_standard_mobile_header_options( $page, $general_tab ) {
	...
	add_action( 'dunker_core_action_after_mobile_header_options_map', 'dunker_core_add_standard_mobile_header_options', 10, 2 );
}
