...
if ( ! function_exists( 'dunker_core_add_minimal_mobile_header_meta' ) ) {
	/**
	 ...
	 */
	function dunker_core_add_minimal_mobile_header_meta( $page ) {
	...
	add_action( 'dunker_core_action_after_page_mobile_header_meta_map', 'dunker_core_add_minimal_mobile_header_meta', 10, 2 );
}
