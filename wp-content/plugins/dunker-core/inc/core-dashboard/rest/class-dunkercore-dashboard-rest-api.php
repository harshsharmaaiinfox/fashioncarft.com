...
if ( ! class_exists( 'DunkerCore_Dashboard_Rest_API' ) ) {
	 ...
	 */
	class DunkerCore_Dashboard_Rest_API {
		...
		public function __construct() {
			...
			add_filter( 'dunker_core_filter_dashboard_js_global_variables', array( $this, 'localize_script' ) );
		...
		/**
		 * @return DunkerCore_Dashboard_Rest_API
		 */
	...
	DunkerCore_Dashboard_Rest_API::get_instance();
}
