...
if ( class_exists( 'DunkerCore_Dashboard_Rest_API' ) ) {
	class DunkerCore_Dashboard_Registration extends DunkerCore_Dashboard_Rest_API {
		...
		/**
		 * @return DunkerCore_Dashboard_Rest_API|DunkerCore_Dashboard_Registration
		 */
		...
		public function register_rest_api_route() {
			...
			register_rest_route(
				...
				array(
					...
					'callback'            => array( DunkerCore_Dashboard::get_instance(), 'purchase_code_registration' ),
	...
	DunkerCore_Dashboard_Registration::get_instance();
}
