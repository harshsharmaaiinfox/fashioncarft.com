...
$label = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'dunker' ), wp_strip_all_tags( $args['product_name'] ) ) : esc_html__( 'Quantity', 'dunker' );
...
<div class="qodef-quantity-buttons quantity">
	...
	<input
		type="<?php echo esc_attr( apply_filters( 'dunker_filter_woo_quantity_input_type', 'text' ) ); ?>"
		...
		aria-label="<?php echo esc_attr_e( 'Qty', 'Product quantity input tooltip', 'dunker' ); ?>"
		size="4"
